...
6. **Welcome** — new subscribers do not automatically get the latest issue. Follow `references/welcome.md`. Raise this when first-issue work starts. Rec depends on plan and whether they will send regularly. Broad automations stay out.
